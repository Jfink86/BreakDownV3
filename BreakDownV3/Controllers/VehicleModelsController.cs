...
namespace BreakDownV3.Controllers
{
    public class VehicleModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ModelID,Year,MakeName,ModelName")] VehicleModel vehicleModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ModelID,Year,MakeName,ModelName")] VehicleModel vehicleModel)
        {
            if (ModelState.IsValid)
            {
